...
<html>
    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <div class="bloc">
                <div class="title">Compra Accão</div>
                <div class="content">
                    <form action="compraraccoesautomatico" id="form1" method="post" autocomplete="off">
                       
                        <div style="float: left; margin-top: 0.8em;">
                            <h5>Introduza a Referência da Ideia:</h5>
                        </div>
                        <div class="input" style="margin-left: 17em;">
                        <s:textfield name="ref" cssStyle="width: 13em;" onkeypress="return isNumber(event)" cssClass="input"/>
                        </div>
                        <div style="float: left; margin-top: 0.8em;">
                            <h5>Percentagem que pretende comprar:</h5>
                        </div>
                        <div class="input" style="margin-left: 15em;">
                            <s:textfield name="numAccoes" cssStyle="width: 18em;" onkeypress="return isNumber(event)" maxlength="15" cssClass="input"/>
                        </div>
                        <div class="submit">
                            <s:submit value="Comprar" method="execute" />
                        </div>
                    </form>
                </div>
            </div>
