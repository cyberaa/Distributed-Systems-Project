...
<html>
    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <div class="bloc">
                <s:if test="%{tituloTopico == ''}">
                    <div class="title">Todas as Ideias de Topico</div>
                </s:if>
                <s:else>
                    <div class="title">Todas as Ideias do Topico ${tituloTopico}</div>
                </s:else>    
                <div class="content">
                    <s:if test="%{tituloTopico == ''}">
                        <form action="listarideiastopicos" id="form1" method="post" autocomplete="off">
                            <div style="float: left; margin-top: 0.8em;">
                                <h5>Introduza o Tópico:</h5>
                            </div>
                            <div class="input" style="margin-left: 13em;">
                            <s:textfield name="tituloTopico" cssStyle="width: 15em;"  maxlength="80" cssClass="input"/>
                            </div>
                    ...
                    <s:else>
                        ...
                        <thead>
                            <tr>
                                <th style="padding-left: 0.3em; text-align: center;">Refª</th>
                                ...
                                <th style="padding-left: 0.3em; text-align: center;">Descricao</th>
                            </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${listaIdeiabean}" var="value">
                            <tr>
                                <td style="padding-left: 0.3em; text-align: center;"><c:out value="${value.idIdeia}"/></td>
                                ...
                                <td style="padding-left: 0.3em; text-align: left;"><c:out value="${value.descricao}"/></td>
                            </tr>    
                        </c:forEach>
                        </tbody>
                    </table>
