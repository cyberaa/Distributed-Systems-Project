...
<html>
    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <div class="bloc">
                <div class="title">Criar um Tópico</div>
                <div class="content">
                    <form action="criartopico" id="form1" method="post" autocomplete="off">
                        <div style="float: left; margin-top: 0.8em;">
                            <h5>Titulo do Tópico:</h5>
                        </div>
                        <div class="input" style="margin-left: 15em;">
                        <s:textfield name="topicoBean.titulo" cssStyle="width: 13em;" maxlength="80" cssClass="input"/>
                        </div>
                        <div style="float: left; margin-top: 0.8em;">
                            <h5>Hashtag do Tópico:</h5>
                        </div>
                        <div class="input" style="margin-left: 15em;">
                            <s:textfield name="topicoBean.hashtag" cssStyle="width: 10em;" maxlength="20" cssClass="input"/>
                        </div>
                        <div class="submit">
