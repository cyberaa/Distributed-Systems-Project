                ...
                <div class="content">
                    <table>
                        ...
                        <c:forEach items="${listaTopicos}" var="value">
                            ...
                            <td class="actions">
                                <a href="../ideia/criarideia?id=${value.idTopico}&nome=${value.titulo}&type=c" title="Adicionar Ideia"><img src="../img/icons/document-blueprint.png" alt=""></a>
                                <a href="../topico/apagartopico?nome=${value.titulo}" title="Apagar Topico"><img src="../img/icons/remove2.png" alt=""></a>
                            </td>
                            </tr>    
                        </c:forEach>
                        </tbody>
