           ...
           <div class="bloc">
                ...
                <div class="content">
                    <table>
                        <thead>
                            <tr>
                                <th style="padding-left: 0.3em; text-align: center;">Numero Accões</th>
                                <th style="padding-left: 0.3em; text-align: center;">Valor Total</th>
                                <th style="padding-left: 0.3em; text-align: center;">Data Transacção</th>
                                <th style="padding-left: 0.3em; text-align: center;">Tipo Compra</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${listaHistorico}" var="value">
                                <tr>
                                    <td style="padding-left: 0.3em; text-align: center;"><c:out value="${value.numAccoes}"/></td>
                                    <td style="padding-left: 0.3em; text-align: center;"><c:out value="${value.valorTotal}"/></td>
                                    <td style="padding-left: 0.3em; text-align: center;"><c:out value="${value.dataTransaccao}"/></td>
                                    <td style="padding-left: 0.3em; text-align: center;"><c:out value="${value.tipoCompra}"/></td>
